...
\emph{26 December 2023: Emails from David Haig}

I wrote him:

\begin{quote}
I am writing as I am working on an annual review on the role of
phenology in the assembly of plant communities and writing up a part on
how we need more life history theory in the phenological assembly
models. But I am struggling a bit with good references.

I'd like to link to relevant theory on this topic, but not finding much
specific to phenology or something that is basically phenology in other
words. I have found some 1980s models from Iwasa but not much more that
connects to timing *within season* (or timing inter- and
intra-annually). I am also trying to track down any empirical data on
investment and phenology. The old Law papers on meadow grass (investment
in reproduction one year affects the next year's investment) seem as
though they would lead to different phenologies across years, but I
cannot find any related timing data.

I was wondering if you knew of any good references or perhaps have any
ideas on who to ask on either topic? Thanks for any thoughts.
\end{quote}

And he replied:

\begin{quote}
Of course I remember you. Nothing comes immediately to mind but I will see what I can find. At some time, I have given thought to variation in ‘reproductive phenology’ For example, pines pollinate ovule in one year but fertilize them in the next year for a twelve month or more reproductive cycle but spruces go from pollination to seed release in a single year. There appears to be a similar difference between white and red oaks. Some plants flower first in the spring and then invest in photosynthesis, others do it the other way around.

One place you might look is in the ‘bet-hedging’ literature and temporal spreading of risk ...

I thought about it a little. There is various literature on determinate versus indeterminant growth and income breeding versus capital breeding. The attached (Ejsmond et al. 2010) may give an entry to some of this literature.
\end{quote}

And then in a followup I wrote ``I remember discussing oaks with you once, but had not heard the
differences between spruce and pines. In the phenology literature we
think flowering first is all about pollination efficiency or drought
avoidance, but I suspect there is more to it -- and tests of the
hypotheses find pretty weak evidence." and he wrote:

\begin{quote}
The attached is an old chapter of mine (\verb|Haig_Cannibalism.pdf|) that briefly discusses the timing of the pine life-cycle on the second page and can give you some references. A few pines take two years between pollination and fertilization.

If you look at a two-year pine branch early in the year, near the tip you have young female cones receiving pollen, move down the branch you have last year’s cone that is going through fertilization (before seed provisioning), and then further back you have the cone from two years back with fully developed seeds. Presumably there are some complex adjustments in resource allocation between years.

The Fagaceae have the longest delays between pollination and fertilization in angiosperms and like the Pinaceae are wind-pollinated (and ectomycorrhizal). 
\end{quote}
