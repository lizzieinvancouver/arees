...
Although perhaps not getting exactly at your comment, we added a paragraph to the priority effects section explaining at which stages phenological priority effects are, and are not, likely to influence community assembly, on lines
\lr{stage1}-\- \lr{stage2}-\.

Also see new text on lines \lr{definestorage4S}-\lr{definestorage4E}?}\\
