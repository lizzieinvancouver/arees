...
pulse_new1 <- data.frame(value = rnorm(1000000, mean = 100, sd = 15),
                        species = "a")
pulse_new2 <- data.frame(value = rnorm(1000000, mean = 100, sd = 20),
                        species = "b")
pulse_new3 <- data.frame(value = rnorm(1000000, mean = 100, sd = 30),
                        species = "c")
pulse_new4 <- data.frame(value = rnorm(1000000, mean = 100, sd = 40),
                        species = "d")
pulse_new5 <- data.frame(value = rnorm(1000000, mean = 100, sd = 50),
                        species = "e")
...
# ggsave("plots/one_pulse_response_new.png",plot=one_pulse_response_new,scale=1,dpi=600)
